...
namespace Web_Shop.RestAPI.Controllers
{
    ...
    public class CustomerController : ControllerBase
    {
        ...
        public CustomerController(ILogger<CustomerController> logger, ICustomerRepository dbContext)
        {
            _customerRepository = dbContext;
            _logger = logger;
        }
        ...
        //{
        //    return Ok(await _customerRepository.Customers.ToListAsync());
        //}
    }
}
